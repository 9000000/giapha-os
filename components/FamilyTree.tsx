    ...
    <div className="w-full h-full relative">
      ...
      */}
        ...
        >
          ...
          {/* Tiêu đề Cuộn giấy */}
          {/* Tiêu đề Cuộn giấy */}
          <div className="flex flex-col items-center justify-center -mb-8 sm:-mb-16 relative w-full pointer-events-none z-10 p-4">
            ...
            <div className="relative inline-flex items-center justify-center text-center w-[1200px] max-w-[150vw]">
              ...
              />
              {/* Text nằm chính giữa khung bao ảnh */}
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center translate-y-[-5%] sm:translate-y-[-8%]">
